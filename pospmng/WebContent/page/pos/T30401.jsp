...
<script type="text/javascript" src="<%= request.getContextPath()%>/ui/pos/TermInfoCupNew.js"></script>
<script type="text/javascript" src="<%= request.getContextPath()%>/ui/pos/TermInfoCupEdit.js"></script>
<script type="text/javascript" src="<%= request.getContextPath()%>/ui/pos/T30401.js"></script>
<script type="text/javascript" src="<%= request.getContextPath()%>/dwr/interface/T30401.js"></script>
