...
<script type="text/javascript" src="<%= request.getContextPath()%>/ui/pos/TermForCheck.js"></script>
<script type="text/javascript" src="<%= request.getContextPath()%>/ui/pos/T30201.js"></script>
