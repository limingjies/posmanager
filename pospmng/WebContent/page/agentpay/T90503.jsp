...
<script type="text/javascript" src="<%= request.getContextPath()%>/ui/agentpay/T90503.js"></script>
<script type="text/javascript" src="<%= request.getContextPath()%>/dwr/interface/SendRspFiles.js"></script>
</head>
<body>
<!-- 发送文件 -->
</body>
