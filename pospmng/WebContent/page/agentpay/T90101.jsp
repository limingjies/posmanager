...
<script type="text/javascript" src="<%= request.getContextPath()%>/ui/agentpay/T90101.js"></script>
<script type="text/javascript" src="<%= request.getContextPath()%>/dwr/interface/GetDSFFiles.js"></script>
</head>
<body>
