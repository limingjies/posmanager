...
<script type="text/javascript" src="<%= request.getContextPath()%>/ui/agentpay/T90701.js"></script>
<script type="text/javascript" src="<%= request.getContextPath()%>/dwr/interface/SendStlmFiles.js"></script>
</head>
<body>
