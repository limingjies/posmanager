...
<script type="text/javascript" src="<%= request.getContextPath()%>/ui/mchnt/T20504.js"></script>
<style type="text/css">
	.role {
		background-image: url(<%= request.getContextPath()%>/ext/resources/images/role_16.png) !important;
	}
</style>
</head>
<body>
