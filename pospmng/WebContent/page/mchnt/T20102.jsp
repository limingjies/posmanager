...
<script type="text/javascript" src="<%= request.getContextPath()%>/ui/mchnt/T20102.js"></script>
...
<script type="text/javascript" src="<%= request.getContextPath()%>/ui/mchnt/MchntHisDetail.js"></script>
