...
<script type="text/javascript" src="<%= request.getContextPath()%>/ui/mchnt/MchntTmpDetailS.js"></script>
<script type="text/javascript" src="<%= request.getContextPath()%>/ui/mchnt/T20904.js"></script>
...
<body>
<!-- 转到T20200.jsp了,去T20200.jsp找js,这个jsp不用了. -->
</body>
</html>