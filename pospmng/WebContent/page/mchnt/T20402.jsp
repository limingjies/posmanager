...
<script type="text/javascript" src="<%= request.getContextPath()%>/ui/mchnt/T20402.js"></script>
<script type="text/javascript" src="<%= request.getContextPath()%>/ui/mchnt/MchntCupDetailS.js"></script>
