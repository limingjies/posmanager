...
<script type="text/javascript" src="<%= request.getContextPath()%>/ui/mchnt/T2040202.js"></script>
<script type="text/javascript" src="<%= request.getContextPath()%>/ui/mchnt/MchntCupDetailSInfo.js"></script>
