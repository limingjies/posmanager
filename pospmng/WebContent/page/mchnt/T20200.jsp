...
<script type="text/javascript" src="<%= request.getContextPath()%>/ui/mchnt/MchntTmpDetailS.js?mt=20160412"></script>
<script type="text/javascript" src="<%= request.getContextPath()%>/ui/mchnt/T20904.js?mt=20160412"></script>
