...
<script type="text/javascript" src="<%= request.getContextPath()%>/ui/mchnt/T20201.js?mt=20160412"></script>
<script type="text/javascript" src="<%= request.getContextPath()%>/ui/mchnt/MchntDetailSS.js?mt=20160412"></script>
