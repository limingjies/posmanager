...
<script type="text/javascript" src="<%= request.getContextPath()%>/ui/route/T110331.js"></script>
<script type="text/javascript" src="<%= request.getContextPath()%>/ui/route/bacthConfig.js"></script>
<script type="text/javascript" src="<%= request.getContextPath()%>/ui/route/routeMapConfig.js"></script>
