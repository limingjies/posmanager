...
<script type="text/javascript" src="<%= request.getContextPath()%>/ui/risk/T40202.js"></script>
<style type="text/css">
	.risk {
		background-image: url(<%= request.getContextPath()%>/ext/resources/images/risk_16.png) !important;
	}
	.query {
		background-image: url(<%= request.getContextPath()%>/ext/resources/images/query_16.png) !important;
	}
	.play {
