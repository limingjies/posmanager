...
<script type="text/javascript" src="<%= request.getContextPath()%>/ui/risk/T40209.js"></script>

<style type="text/css">
	.mchnt {
		background-image: url(<%= request.getContextPath()%>/ext/resources/images/risk_mchnt_16.png) !important;
	}
	.upload {
