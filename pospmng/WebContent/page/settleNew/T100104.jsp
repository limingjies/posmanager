...
<script type="text/javascript" src="<%= request.getContextPath()%>/dwr/interface/T100104.js"></script>
<script type="text/javascript" src="<%= request.getContextPath()%>/ui/settleNew/T100104.js"></script>
<style type="text/css">
	.mchnt {
