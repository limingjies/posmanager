...
var button_Align = 'left';
var columnWidth = 60;
var columnWidth2 = 50;
var cardProdColumnWidth = 40;
var enableHdMenuFlag = true;
var sortableFlag = false;
var ApproveTlrPassMaxLen = 30;

</script>
<script type="text/javascript" src="<%= request.getContextPath()%>/ui/settleNew/T100102.js"></script>
