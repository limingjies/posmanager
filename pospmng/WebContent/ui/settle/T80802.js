Ext.onReady(function() {
	...
	var txnGridStore = new Ext.data.Store({
		proxy: new Ext.data.HttpProxy({
			url: 'gridPanelStoreAction.asp?storeId=amtSettleDtlInfo'
		}),
	...
	var txnColModel = new Ext.grid.ColumnModel([
		...
		{header: '清算日期',dataIndex: 'settlmtDate',align: 'center',renderer: formatDt,width: 90},
//		{header: '实际结算日期',dataIndex: 'actSettlmtDate',align: 'center',renderer: formatDt,width: 120},
		...
		{header: '开户户账号',dataIndex: 'mchtAcct',align: 'left',width: 160},
		{header: '开户名称',dataIndex: 'acctNm',align: 'left',width: 80},
		{header: '开户行名称',dataIndex: 'settleBankNm',align: 'left',width: 190},
		{header: '开户行行号',dataIndex: 'openStlno',align: 'center',width: 100},
		{header: '交易金额',dataIndex: 'txnAmt',align: 'right',width: 120},
		{header: '手续费',dataIndex: 'settleFee',align: 'right'},
		{header: '清算金额',dataIndex: 'settleAmt',align: 'right',width: 120},
		{header: '交易通道',dataIndex: 'channelName',align: 'center'}
	]);
