Ext.onReady(function() {
	...
	var txnGridStore = new Ext.data.Store({
		proxy: new Ext.data.HttpProxy({
			url: 'gridPanelStoreAction.asp?storeId=txnHisInfo'
		}),
...
//		autoLoad: true
	...
	var txnColModel = new Ext.grid.ColumnModel([
		...
		{id:'txnName',header: '交易类型',dataIndex: 'txnName',align: 'left',width: 80},
...
//		{header: '冲正流水号',dataIndex: 'revsalSsn',align: 'center',width: 80},
...
//							showErrorMsg("下载报表失败!",txnGrid);
							showAlertMsg(rspObj.msg,txnGrid);
						}
					},
					failure: function(){
						hideMask();
