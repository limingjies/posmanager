Ext.onReady(function() {
	...
	var txnGridStore = new Ext.data.Store({
		proxy: new Ext.data.HttpProxy({
			url: 'gridPanelStoreAction.asp?storeId=smallAmtSettleInfoNew'
		}),
		reader: new Ext.data.JsonReader({
			...
			{name: 'hangingFlag',mapping: 'hangingFlag'}
		]),
		autoLoad: true
	});
...
//		{header: '挂账处理日期',dataIndex: 'actSettlmtDate',align: 'center',renderer: formatDt,width: 100},
		{header: '商户名',dataIndex: 'mchtNoNm',width: 250,align: 'left',id:'mchtNoName'},
		{header: '受理机构',dataIndex: 'brhIdNm',align: 'left',width: 300},
		{header: '挂账金额',dataIndex: 'settleAmt',align: 'right',width: 200}
//		{header: '挂账标志',dataIndex: 'hangingFlag',renderer: setFlag,align: 'center'}
	]);
