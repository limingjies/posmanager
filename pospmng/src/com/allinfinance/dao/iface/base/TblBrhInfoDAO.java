...
public interface TblBrhInfoDAO {
	...
	public java.util.List<com.allinfinance.po.TblBrhInfo> findAll ();
	...
	public List<TblBrhInfo> getUpbrhid(String oprBrhId);

	TblBrhInfo getByCreateNewNo(String createNewNo);
