...
public interface TblMchntTpGrpDAO {
	public TblInfMchntTpGrp get(TblInfMchntTpGrpPK key);

	public TblInfMchntTpGrp load(TblInfMchntTpGrpPK key);

	public java.util.List<TblInfMchntTpGrp> findAll ();
