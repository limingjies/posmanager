...
public interface TblRouteRuleInfoDAO {
	public TblRouteRuleInfo get(Integer key);

	public TblRouteRuleInfo load(Integer key);

	public java.util.List<TblRouteRuleInfo> findAll();
	 ...
	 */
	public void delete(TblRouteRuleInfo tblCityCode);
