...
public interface TblTermInfTmpDAO {
	public com.allinfinance.po.TblTermInfTmp get(TblTermInfTmpPK key);
	
	public List<TblTermInfTmp> getByMchnt(String mchntId);

	public com.allinfinance.po.TblTermInfTmp load(TblTermInfTmpPK key);
	 ...
	 */
	public void delete(TblTermInfTmpPK id);
