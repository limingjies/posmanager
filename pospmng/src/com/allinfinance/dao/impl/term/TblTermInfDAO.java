...
public class TblTermInfDAO extends _RootDAO<com.allinfinance.po.TblTermInf> implements com.allinfinance.dao.iface.term.TblTermInfDAO{

	public TblTermInfDAO () {}
	
	/* (non-Javadoc)
	 * @see com.allinfinance.dao.iface.TblTermInfDAO#findAll()
	 */
	...
	public Class<com.allinfinance.po.TblTermInf> getReferenceClass () {
		return com.allinfinance.po.TblTermInf.class;
	}
	
	
	/**
	 * Cast the object as a com.allinfinance.po.TblTermInf
	 */
	public com.allinfinance.po.TblTermInf cast (Object object) {
		return (com.allinfinance.po.TblTermInf) object;
	}
	
	
	public com.allinfinance.po.TblTermInf load(java.lang.String key)
	{
		return (com.allinfinance.po.TblTermInf) load(getReferenceClass(), key);
	}
	
	public com.allinfinance.po.TblTermInf get(java.lang.String key)
	{
		return (com.allinfinance.po.TblTermInf) get(getReferenceClass(), key);
	}
	
	@SuppressWarnings("unchecked")
	public java.util.List<com.allinfinance.po.TblTermInf> loadAll()
	{
