 ...
 *  
 */
public class HessianBatch implements HessianBase {
	
	private static Logger log = Logger.getLogger(HessianBatch.class);
	/**
	 * 请求信息
	 */
	...
	public void processe(){
    	try{
    		log.info(requestMsg);
    		responseMsg = CommonFunction.getBatchService().process(requestMsg);
