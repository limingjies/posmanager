...
public class T80603BOTarget implements T80603BO {
	


	private ICommQueryDAO commQueryDAO;
	private static Logger log = Logger.getLogger(T80603BOTarget.class);
	
	@Override
	public String update(String falg, String batId,String restGrpId) throws Exception {
		String sql = "UPDATE TBL_BAT_TASK_CTL SET BAT_STATUS = '0' ,beg_time='' ,end_time ='' WHERE 1=1";
		if("1".equals(falg)) {
...
//		}
	...
	public String resetBat(String id) throws Exception {
		...
		String sql = "UPDATE TBL_BAT_TASK_CTL SET BAT_STATUS = '0' ,beg_time='' ,end_time =''  WHERE BAT_ID = '" + id + "'";
		commQueryDAO.excute(sql);
		log.info(sql);
		return Constants.SUCCESS_CODE;
	}
	...
	public String resetAsn(String id2) throws Exception {
		// TODO Auto-generated method stub
		String sql = "UPDATE TBL_BAT_TASK_CTL SET ASN_STATUS = '0' ,beg_time='' ,end_time =''  WHERE BAT_ID = '" + id2 + "'";
		commQueryDAO.excute(sql);
		log.info(sql);
		return Constants.SUCCESS_CODE;
	}
