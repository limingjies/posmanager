...
public class TblAmtbackApplymis implements Serializable {

	// primary key
	private TblAmtbackApplyPKmis tblAmtbackApplyPKmis;
	...
	public TblAmtbackApplymis() {
	}
	
	public TblAmtbackApplyPKmis getTblAmtbackApplyPKmis() {
		return tblAmtbackApplyPKmis;
	}

	public void setTblAmtbackApplyPKmis(TblAmtbackApplyPKmis tblAmtbackApplyPKmis) {
		this.tblAmtbackApplyPKmis = tblAmtbackApplyPKmis;
	}

	public java.lang.String getApplyState() {
		return applyState;
	}
	public void setApplyState(java.lang.String applyState) {
