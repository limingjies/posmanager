...
public class TblBrhSettleInfHis implements Serializable{

	private TblBrhSettleInfHisPK id;
	...
	public TblBrhSettleInfHis() {
//		super();
	}

	public TblBrhSettleInfHisPK getId() {
		return id;
	}

	public void setId(TblBrhSettleInfHisPK id) {
		this.id = id;
	}
