...
public class TblMchtCupInfoTmp implements Serializable {
	 ...
	 */
	public TblMchtCupInfoTmp (java.lang.String mcht_no) {
	...
	public boolean equals (Object obj) {
		...
		if (!(obj instanceof com.allinfinance.po.TblMchtCupInfoTmp)) return false;
		else {
			com.allinfinance.po.TblMchtCupInfoTmp TblMchtCupInfoTmp = (com.allinfinance.po.TblMchtCupInfoTmp) obj;
			if (null == this.getMcht_no() || null == TblMchtCupInfoTmp.getMcht_no()) return false;
			else return (this.getMcht_no().equals(TblMchtCupInfoTmp.getMcht_no()));
		}
	}
