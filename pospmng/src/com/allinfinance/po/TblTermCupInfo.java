...
public class TblTermCupInfo implements Serializable {
	 ...
	 */
	public TblTermCupInfo (java.lang.String term_id) {
		this.setTerm_id(term_id);
		initialize();
	}

	public TblTermCupInfo() {
		super();
	}
	...
	public boolean equals (Object obj) {
		...
		if (!(obj instanceof com.allinfinance.po.TblTermCupInfo)) return false;
		else {
			com.allinfinance.po.TblTermCupInfo TblTermCupInfo = (com.allinfinance.po.TblTermCupInfo) obj;
			if (null == this.getTerm_id() || null == TblTermCupInfo.getTerm_id()) return false;
			else return (this.getTerm_id().equals(TblTermCupInfo.getTerm_id()));
		}
	}
