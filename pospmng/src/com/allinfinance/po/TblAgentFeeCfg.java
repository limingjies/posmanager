...
public class TblAgentFeeCfg implements java.io.Serializable {
	...
	/** default constructor */
	public TblAgentFeeCfg() {
	}

	/** minimal constructor */
	public TblAgentFeeCfg(String discId, BigDecimal seq) {
		this.discId = discId;
		this.seq = seq;
	}

	/** full constructor */
	public TblAgentFeeCfg(String discId, String agentNo, BigDecimal seq,
