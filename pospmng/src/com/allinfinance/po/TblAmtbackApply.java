...
public class TblAmtbackApply implements Serializable {

	// primary key
	private TblAmtbackApplyPK tblAmtbackApplyPK;
	...
	public TblAmtbackApply() {
	}
	
	public TblAmtbackApplyPK getTblAmtbackApplyPK() {
		return tblAmtbackApplyPK;
	}

	public void setTblAmtbackApplyPK(TblAmtbackApplyPK tblAmtbackApplyPK) {
		this.tblAmtbackApplyPK = tblAmtbackApplyPK;
	}
