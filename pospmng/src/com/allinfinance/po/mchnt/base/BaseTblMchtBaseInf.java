...
/**
 * This is an object that contains data related to the TBL_MCHT_BASE_INF table.
 * Do not modify this class because it will be overwritten if the configuration
 * file related to this class is modified.
 * 
 * @hibernate.class table="TBL_MCHT_BASE_INF"
 */

public abstract class BaseTblMchtBaseInf implements Serializable {

	public static String REF = "TblMchtBaseInf";
	 ...
	 */
	public BaseTblMchtBaseInf(java.lang.String mchtNo) {
	 ...
	 */
	public BaseTblMchtBaseInf(java.lang.String mchtNo, java.lang.String mchtNm,
			java.lang.String addr, java.lang.String mcc,
			java.lang.String licenceNo, java.lang.String licenceEndDate,
			java.lang.String bankLicenceNo, java.lang.String faxNo,
		...
		this.setCompNm(compNm);
		this.setCompaddr(compaddr);
		this.setFinacontact(finacontact);
		this.setFinacommTel(finacommTel);
		this.setFinacommEmail(finacommEmail);
		this.setBusInfo(busInfo);
		this.setBusArea(busArea);
		this.setMonaveTrans(monaveTrans);
		this.setSigaveTrans(sigaveTrans);
		this.setContstartDate(contstartDate);
		this.setContendDate(contendDate);
	...
	/**
	 * Return the value associated with the column: CDC_MCHT_FLG
	 */
	...
	/**
	 * Set the value related to the column: CDC_MCHT_FLG
	 * 
	 * @param cdcMchtFlg
	 *            the CDC_MCHT_FLG value
	 */
	...
	/**
	 * @param settleAreaNo
	 *            the settleAreaNo to set
	 */
	public void setSettleAreaNo(String settleAreaNo) {
		SettleAreaNo = settleAreaNo;
	}
	...
	public String getMchntAttr() {
		return mchntAttr;
	}

	public void setMchntAttr(String mchntAttr) {
		this.mchntAttr = mchntAttr;
	}
	...
	public boolean equals(Object obj) {
		if (null == obj)
			return false;
		if (!(obj instanceof com.allinfinance.po.mchnt.TblMchtBaseInf))
			return false;
		else {
			com.allinfinance.po.mchnt.TblMchtBaseInf tblMchtBaseInf = (com.allinfinance.po.mchnt.TblMchtBaseInf) obj;
			if (null == this.getMchtNo() || null == tblMchtBaseInf.getMchtNo())
				return false;
			else
				return (this.getMchtNo().equals(tblMchtBaseInf.getMchtNo()));
		}
	}
	...
	public String toString() {
		return "BaseTblMchtBaseInf [mchtNo=" + mchtNo + ", mchtNm=" + mchtNm
				+ ", rislLvl=" + rislLvl + ", mchtLvl=" + mchtLvl
				...
				+ ", addr=" + addr + ", homePage=" + homePage + ", mcc=" + mcc
				+ ", tcc=" + tcc + ", etpsAttr=" + etpsAttr + ", mngMchtId="
				+ mngMchtId + ", mchtGrp=" + mchtGrp + ", mchtAttr=" + mchtAttr
				...
				+ ", recCrtTs=" + recCrtTs + ", updOprId=" + updOprId
				+ ", crtOprId=" + crtOprId + ", internalNo=" + internalNo
				+ ", reject=" + reject + ", mchntAttr=" + mchntAttr
				+ ", linkPer=" + linkPer + ", SettleAreaNo=" + SettleAreaNo
				+ ", MainTlr=" + MainTlr + ", CheckTlr=" + CheckTlr
				+ ", compNm=" + compNm + ", compaddr=" + compaddr
				+ ", finacontact=" + finacontact + ", finacommTel="
				+ finacommTel + ", finacommEmail=" + finacommEmail
				+ ", busInfo=" + busInfo + ", busArea=" + busArea
				+ ", monaveTrans=" + monaveTrans + ", sigaveTrans="
