...
/**
 * TblMchtCashInfTmpTmp entity. @author MyEclipse Persistence Tools
 */

public class TblMchtCashInfTmpTmp implements java.io.Serializable {
	...
	/** default constructor */
	public TblMchtCashInfTmpTmp() {
	}

	/** minimal constructor */
	public TblMchtCashInfTmpTmp(String mchtId) {
		this.mchtId = mchtId;
	}

	/** full constructor */
	public TblMchtCashInfTmpTmp(String mchtId, String cashTp, String feeTp,
