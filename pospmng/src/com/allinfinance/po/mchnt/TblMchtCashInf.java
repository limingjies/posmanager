...
/**
 * TblMchtCashInf entity. @author MyEclipse Persistence Tools
 */

public class TblMchtCashInf implements java.io.Serializable {
	...
	/** default constructor */
	public TblMchtCashInf() {
	}

	/** minimal constructor */
	public TblMchtCashInf(String mchtId) {
		this.mchtId = mchtId;
	}

	/** full constructor */
	public TblMchtCashInf(String mchtId, String cashTp, String feeTp,
