...
public class TblTermRefuse implements Serializable {
	private static final long serialVersionUID = 1L;

	public static String REF = "TblTermRefuse";
	...
	// primary key
	private com.allinfinance.po.TblTermRefusePK id;
     ...
     * @hibernate.id
     */
	public com.allinfinance.po.TblTermRefusePK getId () {
		return id;
	}
	 ...
	 * @param id the new ID
	 */
	public void setId (com.allinfinance.po.TblTermRefusePK id) {
		this.id = id;
	...
	public boolean equals (Object obj) {
		...
		if (!(obj instanceof com.allinfinance.po.TblTermRefuse)) return false;
		else {
			com.allinfinance.po.TblTermRefuse tblTermRefuse = (com.allinfinance.po.TblTermRefuse) obj;
			if (null == this.getId() || null == tblTermRefuse.getId()) return false;
			else return (this.getId().equals(tblTermRefuse.getId()));
		}
	}
