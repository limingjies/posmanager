...
public class TblTermInfTmp implements Serializable {
	 ...
	 */
	public TblTermInfTmp (com.allinfinance.po.TblTermInfTmpPK id) {
		this.setId(id);
		initialize();
	}
	 ...
	 */
	public TblTermInfTmp (
		com.allinfinance.po.TblTermInfTmpPK id,
	...
	{
		this.setMchtCd(Constants.DEFAULT);
		this.setTermIdId(Constants.DEFAULT);
	...
	// primary key
	private com.allinfinance.po.TblTermInfTmpPK id;

	// fields
	private java.lang.String mchtCd;
	private java.lang.String termSerialNum;
     ...
     * @hibernate.id
     */
	public com.allinfinance.po.TblTermInfTmpPK getId () {
		return id;
	}
	 ...
	 * @param id the new ID
	 */
	public void setId (com.allinfinance.po.TblTermInfTmpPK id) {
		this.id = id;
	...
	public boolean equals (Object obj) {
		...
		if (!(obj instanceof com.allinfinance.po.TblTermInfTmp)) return false;
		else {
			com.allinfinance.po.TblTermInfTmp tblTermInfTmp = (com.allinfinance.po.TblTermInfTmp) obj;
			if (null == this.getId() || null == tblTermInfTmp.getId()) return false;
			else return (this.getId().equals(tblTermInfTmp.getId()));
		}
	}
	...
	public Serializable cloneHasExists(TblTermInf tblTermInf)
	{
		tblTermInf.setMchtCd(this.mchtCd);
		tblTermInf.setTermSerialNum(this.termSerialNum);
		tblTermInf.setTermIdId(this.termIdId);
...
//		tblTermInf.setProductCd(this.productCd);
	...
	public java.lang.String getTermSerialNum() {
		return termSerialNum;
	}

	public void setTermSerialNum(java.lang.String termSerialNum) {
