...
public class T80216Action extends ReportBaseAction {
	...
	public void reportAction() throws Exception {
		...
		reportCreator
				.initReportData(getJasperInputSteam("T80216.jasper"),
	...
	protected String genSql() {
		...
		sb.append(" group by substr(a.txn_key, 26, 12), substr(a.date_settlmt,1,8) order by substr(a.date_settlmt,1,8)) o"
				+ " union "
		...
		sb.append(whereSql.toString());
		sb.append("group by substr(a.txn_key, 26, 12), substr(a.date_settlmt,1,8) order by substr(a.date_settlmt,1,8))) p ");
