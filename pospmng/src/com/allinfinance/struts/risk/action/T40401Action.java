...
public class T40401Action extends BaseAction{
	...
	private String accept() {
		tblWhiteMchtApply.setCheckStatus(RiskConstants.FST_CHECK_T);
		tblWhiteMchtCheck.setCheckStatus(RiskConstants.FST_CHECK_T);
	...
	private String refuse() {
		tblWhiteMchtApply.setCheckStatus(RiskConstants.FST_CHECK_F);
		tblWhiteMchtCheck.setCheckStatus(RiskConstants.FST_CHECK_F);
		tblWhiteMchtCheck.setMchtCaseDesp(mchtCaseDesp);
		tblWhiteMchtCheck.setRefuseReason(refuseReason);
		return t40401BO.check(tblWhiteMchtCheck, tblWhiteMchtApply);
	}
