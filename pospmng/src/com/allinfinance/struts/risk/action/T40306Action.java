...
public class T40306Action  extends ReportBaseAction  {
...
//		}
		...
		reportCreator.initReportData(getJasperInputSteam("T40306.jasper"), parameters, 
		...
		reportCreator.exportReport(outputStream, "单户同卡号相同金额交易监测");
		
		if(Constants.REPORT_EXCELMODE.equals(reportType))
			callDownload(fileName,"单户同卡号相同金额交易监测.xls");
		else if(Constants.REPORT_PDFMODE.equals(reportType))
			callDownload(fileName,"单户同卡号相同金额交易监测.pdf");
