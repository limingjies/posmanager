...
public class T40308Action  extends ReportBaseAction  {
...
//		}
		...
		reportCreator.initReportData(getJasperInputSteam("T40308.jasper"), parameters, 
		...
		reportCreator.exportReport(outputStream, "单户交易被拒情况监测");
		
		if(Constants.REPORT_EXCELMODE.equals(reportType))
			callDownload(fileName,"单户交易被拒情况监测.xls");
		else if(Constants.REPORT_PDFMODE.equals(reportType))
			callDownload(fileName,"单户交易被拒情况监测.pdf");
