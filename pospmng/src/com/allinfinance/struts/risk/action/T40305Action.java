...
public class T40305Action  extends ReportBaseAction  {
...
//		}
		...
		reportCreator.initReportData(getJasperInputSteam("T40305.jasper"), parameters, 
		...
		reportCreator.exportReport(outputStream, "单户同一卡号监控");
		
		if(Constants.REPORT_EXCELMODE.equals(reportType))
			callDownload(fileName,"单户同一卡号监控.xls");
		else if(Constants.REPORT_PDFMODE.equals(reportType))
			callDownload(fileName,"单户同一卡号监控.pdf");
