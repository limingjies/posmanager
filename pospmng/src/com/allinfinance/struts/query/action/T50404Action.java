...
public class T50404Action extends ReportBaseAction {
	...
	public void reportAction() throws Exception {
		...
		reportCreator
				.initReportData(getJasperInputSteam("T802171.jasper"),
	...
	protected String genSql() {
		...
		sb.append("select count(*),sum(abs(a.MCHT_AMT_CR-a.MCHT_AMT_DB)) as txn_amt,(select mchnt_tp ||' - '||descr from tbl_inf_mchnt_tp where mchnt_tp=mcc )mcc from tbl_clear_dtl a "
