...
public class T50106Action extends ReportBaseAction{
...
//		List<String[]> paramList=new ArrayList<String[]>();
		...
		String rnName="RN50106RN_";
		String resName= SysParamUtil.getParam("RN50106RN");
		
//        String[] coulmHeader={"交易日期","交易时间","卡号","账户类型","商户编号","商户名称","终端号","终端类型","系统流水号","所属机构",
//        		"交易通道","交易类型","交易结果","交易应答","交易金额","冲正结果","撤销结果"};
...
//		excelReportCreator.setParamList(paramList);
	...
	private String getDataSql() {
		...
		//String sql = "select txn_date, txn_time,pan,acct_type,card_accp_id,mcht_name,card_accp_term_id,term_tp,sys_seq_num,brh_id_name,settle_brh_name,txn_num_name,trans_ret_sta,resp_name,amt,revsal_flag_name,cancel_flag_name "
...
//			  " and a.txn_num in ('1011','1091','1101','1111','1121','1141','1161','2011','2091','2101','2111','2121','3011','3091','3101','3111','3121','4011','4091','4101','4111','4121','5151','5161') ");
		...
		whereSql.append(" AND a.inst_date").append(" >= ").append(CommonFunction.getCurrentDate()).append("000000 ");
    	whereSql.append(" AND a.inst_date").append(" <= ").append(CommonFunction.getCurrentDate()).append("999999 ");
