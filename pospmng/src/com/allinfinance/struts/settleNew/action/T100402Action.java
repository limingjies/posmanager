 ...
 * version: 1.0
 */
public class T100402Action extends ReportBaseAction{
	...
	protected void reportAction() throws Exception {
		...
		String rnName="RN100402RN_";
		String resName= SysParamUtil.getParam("RN100402RN");
	...
	private String getCountSql(){
		...
		String sql="SELECT COUNT(*) FROM TBL_ZTH_DTL_NEW a "
				+ whereSql;
		return sql.toString();
	}
	...
	protected String genSql(){
		...
		String sql="SELECT "
				...
				+ "FROM TBL_ZTH_DTL_NEW a LEFT JOIN TBL_ZTH_NEW b ON a.INST_DATE = b.INST_DATE AND a.SYS_SEQ_NUM = b.SYS_SEQ_NUM "
				+ whereSql;
		return sql.toString();
	}
